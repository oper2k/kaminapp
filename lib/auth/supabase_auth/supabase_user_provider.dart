...
class KaminAppSupabaseUser extends BaseAuthUser {
  KaminAppSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> kaminAppSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = KaminAppSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
