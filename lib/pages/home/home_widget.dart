                          ...
                          Expanded(
                            ...
                            child: FutureBuilder<List<TestsRow>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                return Container(
                                  decoration: BoxDecoration(),
                                  child: FutureBuilder<List<TestsAnswersRow>>(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    decoration:
                                                                      ...
                                                                      color: valueOrDefault<
                                                                          Color>(
                                                                        functions.diffBetweenTwoDates(columnUsersRow?.createdTime) >=
                                                                                progressItem
                                                                            ? Color(0xFF142D65)
                                          ...
                                          child: FlutterFlowIconButton(
                                            ...
                                            onPressed: () async {
                                              ...
                                              if (FFAppState().userAdmin ==
                                                ...
                                                if (containerChatsRow?.uid !=
                                                        null &&
                                                    containerChatsRow?.uid !=
                                                        '') {
                                                  logFirebaseEvent(
                                                      'IconButton_navigate_to');
                              ...
                              FutureBuilder<List<CourseRow>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  return Row(
                                    mainAxisSize: MainAxisSize.max,
                                    children: List.generate(
                                        rowCourseRowList.length, (rowIndex) {
                                      final rowCourseRow =
